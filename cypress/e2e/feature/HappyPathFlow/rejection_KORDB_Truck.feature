...
Feature: Rejection flow of Truck for KOR - DB store


    Scenario: Before starting with assessment take Photo of Vehical
        Given Login with valid email and password
        When Select Store "KOR - DB"
        When User gets StockId of "Truck" for "KOR - DB" store from "Inventory"
        When User provides StockId
        When User starts "Photo First"
        When User "Submit" Photo First


    Scenario: Complete work on Porter to Assessment
        Given Login with valid email and password
        When Select Store "KOR - DB"
        When User provides StockId
        When User starts "Porter to Assessment"
        When User "Submit" Porter to Assessment
...
Scenario: Complete work on Porter to Sales
    ...
    Scenario: Reject work on Dent Removal
        Given Login with valid email and password
        When Select Store "KOR - DB"
        When User provides StockId
    ...
    Scenario: Reject work on Interior
        Given Login with valid email and password
        When Select Store "KOR - DB"
        When User provides StockId
...
Scenario: Reject work on Final photo
        Given Login with valid email and password
        When Select Store "KOR - DB"
        When User provides StockId
