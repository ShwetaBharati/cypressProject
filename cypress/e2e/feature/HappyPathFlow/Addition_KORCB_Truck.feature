Feature: End to end flow for Addition of work in KOR - CB for Truck
    ...
    Scenario: Complete work on Assessment
        ...
        When Select Store "KOR - CB"
        When User gets StockId of "Truck" for "KOR - CB" store from "Inventory"
