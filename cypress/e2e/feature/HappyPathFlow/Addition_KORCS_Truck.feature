Feature: End to end flow for Addition of work in KOR - CS for Truck
    ...
    Scenario: Complete work on Assessment
        ...
        When Select Store "KOR - CS"
        When User gets StockId of "Truck" for "KOR - CS" store from "Inventory"
